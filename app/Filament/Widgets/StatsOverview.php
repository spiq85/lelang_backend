...
{
    protected static ?int $sort = -1; // muncul di atas dashboard
    ...
    protected function getStats(): array
    {
        ...
        if ($user->role === 'seller') {
            // Seller hanya lihat batch milik dia sendiri
        ...
        // Hanya admin yang lihat statistik global
        if ($user->role === 'admin') {
    ...
    // Biar widget selalu muncul di dashboard
